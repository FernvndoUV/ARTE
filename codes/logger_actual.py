...
import control, utils, read_sensors

from rigol_dp832 import *
...
def receive_10gbe_data(folder, file_time,total_time=None,ip_addr='192.168.2.10',
    ...
    port        :   10gbe port
    rigol_ip    :   rigol ip (The channel 2 is connected to the RF noise source)
    """
    ...
    #seteo voltaje y corriente chn2 rigol, control fuente de ruido
...
if __name__ == '__main__':
    ...
    receive_10gbe_data(folder=args.folder, file_time=args.file_time,total_time=args.total_time,
            ...
            DMs=dms, cal_time=args.cal_time, temp=args.no_temp, temp_time=args.temp_time, rigol_ip = args.rigol_ip)
